...
DEFAULT_OCR_PROMPT = """Ты OCR для рукописных заказов КАНАЛИЗАЦИИ (серой ПП).

ДОПУСТИМЫЕ ТОВАРЫ:
труба, отвод, тройник, переход, муфта, заглушка, аэратор, ревизия, крестовина, хомут, патрубок

ИГНОРИРУЙ (НЕ товары):
корпус, эмульсия, задерживающий, непонятный текст

ВСЁ = КАНАЛИЗАЦИЯ:
- "Труба 50" → "Труба кан. 50..."
- "Заглушка ПП 110" → "Заглушка кан. 110"
- "Муфта 50" → "Муфта кан. 50"
- ППР = только если "арм", "PN20", "PN25"
...
"Тройник 50×50×87" → "Тройник кан. 50 87°"
