...
ТИПЫ ТОВАРОВ (распознавай правильно!):
- Труба (с толщиной стенки в скобках: 2.2, 2.7, 3.2, 1.5 мм)
- Отвод (НЕ "отбой"!) - углы 45°, 87°, 90°
- Тройник - размеры через × (110×110×45)
- Муфта ремонтная (НЕ просто "муфта"!)
...
ФОРМАТ ЗАПИСИ:
Товар размер×размер (толщина) - количество шт

ПРИМЕРЫ:
- "Труба 110×2000 (3.2) - 30шт" → name: "Труба ПП 110×2000 3.2мм", qty: 30
- "Отвод 110×45 - 300" → name: "Отвод ПП 110 45°", qty: 300
- "Муфта 110 ремонт - 400" → name: "Муфта ремонтная 110", qty: 400
- "50×1000 (1.5) - 600" → name: "Труба ПП 50×1000 1.5мм", qty: 600

ВАЖНО:
- Количество ВСЕГДА в конце строки (шт, штук или просто число)
- Толщина стенки в скобках - включай в название!
- Если строка начинается с размера (50×45) - это продолжение предыдущего типа товара
