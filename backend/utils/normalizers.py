...
PRODUCT_SYNONYMS = {
    ...
    "редукция": "переходник",
    "редукционная": "переходник",  # муфта редукционная = переходнк
    "редукционный": "переходник",  # тройник редукционный = тройник-переходник
    "редукционное": "переходник",
    # Канализация
    ...
    "н р": "нар рез",
    "н/р": "нар рез",
    "нр": "нар рез",  # НР = наружная резьба → нар рез (как в каталоге Jakko)
    "вр": "вн рез",  # ВР = внутренняя резьба → вн рез (как в каталоге Jakko)
    "вн": "вн рез",  # ВН = внутренняя → вн рез
    "пн": "вн рез",  # ПН = опечатка ВН
